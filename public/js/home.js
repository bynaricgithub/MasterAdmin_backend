...
// Notice Board
$(document).ready(function () {
  var scrollSpeed = 30; // Adjust speed for marquee effect

  function startMarquee() {
    var noticeboardHeight = $(".noticeboard").height();
    var scroller = $("#noticeScroller");
    var scrollerHeight = scroller.height();
    scroller.animate({
      top: -scrollerHeight + "px"
    },
    // Scroll up to the height of the scroller
    (scrollerHeight + noticeboardHeight) * scrollSpeed,
    // Duration for the scroll effect
    "linear",
    // Continuous linear scrolling
    function () {
